...
// Files
const uint64_t a_file = 0x8080808080808080ull;
const uint64_t b_file = 0x4040404040404040ull;
const uint64_t c_file = 0x2020202020202020ull;
const uint64_t d_file = 0x1010101010101010ull;
const uint64_t e_file = 0x0808080808080808ull;
const uint64_t f_file = 0x0404040404040404ull;
const uint64_t g_file = 0x0202020202020202ull;
const uint64_t h_file = 0x0101010101010101ull;
// rows
const uint64_t row_1 = 0x00000000000000ffull;
const uint64_t row_2 = 0x000000000000ff00ull;
const uint64_t row_3 = 0x0000000000ff0000ull;
const uint64_t row_4 = 0x00000000ff000000ull;
const uint64_t row_5 = 0x000000ff00000000ull;
const uint64_t row_6 = 0x0000ff0000000000ull;
const uint64_t row_7 = 0x00ff000000000000ull;
const uint64_t row_8 = 0xff00000000000000ull; 
// diagonals left corner
const uint64_t diag_l_1 = 0x0000000000000080ull;
const uint64_t diag_l_2 = 0x0000000000008040ull;
const uint64_t diag_l_3 = 0x0000000000804020ull;
const uint64_t diag_l_4 = 0x0000000080402010ull;
const uint64_t diag_l_5 = 0x0000008040201008ull;
const uint64_t diag_l_6 = 0x0000804020100804ull;
const uint64_t diag_l_7 = 0x0080402010080402ull;
const uint64_t diag_l_8 = 0x8040201008040201ull;
const uint64_t diag_l_9 = 0x4020100804020100ull;
const uint64_t diag_l_10 = 0x2010080402010000ull;
const uint64_t diag_l_11 = 0x1008040201000000ull;
const uint64_t diag_l_12 = 0x0804020100000000ull;
const uint64_t diag_l_13 = 0x0402010000000000ull;
const uint64_t diag_l_14 = 0x0201000000000000ull;
const uint64_t diag_l_15 = 0x0100000000000000ull;
// diagonals right corner
const uint64_t diag_r_1 = 0x0000000000000001ull;
const uint64_t diag_r_2 = 0x0000000000000102ull;
const uint64_t diag_r_3 = 0x0000000000010204ull;
const uint64_t diag_r_4 = 0x0000000001020408ull;
const uint64_t diag_r_5 = 0x0000000102040810ull;
const uint64_t diag_r_6 = 0x0000010204081020ull;
const uint64_t diag_r_7 = 0x0001020408102040ull;
const uint64_t diag_r_8 = 0x0102040810204080ull;
const uint64_t diag_r_9 = 0x0204081020408000ull;
const uint64_t diag_r_10 = 0x0408102040800000ull;
const uint64_t diag_r_11 = 0x0810204080000000ull;
const uint64_t diag_r_12 = 0x1020408000000000ull;
const uint64_t diag_r_13 = 0x2040800000000000ull;
const uint64_t diag_r_14 = 0x4080000000000000ull;
const uint64_t diag_r_15 = 0x8000000000000000ull;
